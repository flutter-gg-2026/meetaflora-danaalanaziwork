...
mixin _$SimilarImageModel {
 ...
 String get id; String get url;@JsonKey(name: "url_small") String get urlSmall;@JsonKey(name: "license_name") String? get licenseName;@JsonKey(name: "license_url") String? get licenseUrl; String? get citation; double? get similarity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SimilarImageModel&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.urlSmall, urlSmall) || other.urlSmall == urlSmall)&&(identical(other.licenseName, licenseName) || other.licenseName == licenseName)&&(identical(other.licenseUrl, licenseUrl) || other.licenseUrl == licenseUrl)&&(identical(other.citation, citation) || other.citation == citation)&&(identical(other.similarity, similarity) || other.similarity == similarity));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,url,urlSmall,licenseName,licenseUrl,citation,similarity);

@override
String toString() {
  return 'SimilarImageModel(id: $id, url: $url, urlSmall: $urlSmall, licenseName: $licenseName, licenseUrl: $licenseUrl, citation: $citation, similarity: $similarity)';
}
...
@useResult
$Res call({
 String id, String url,@JsonKey(name: "url_small") String urlSmall,@JsonKey(name: "license_name") String? licenseName,@JsonKey(name: "license_url") String? licenseUrl, String? citation, double? similarity
});
...
/// Create a copy of SimilarImageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? url = null,Object? urlSmall = null,Object? licenseName = freezed,Object? licenseUrl = freezed,Object? citation = freezed,Object? similarity = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,urlSmall: null == urlSmall ? _self.urlSmall : urlSmall // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String url, @JsonKey(name: "url_small")  String urlSmall, @JsonKey(name: "license_name")  String? licenseName, @JsonKey(name: "license_url")  String? licenseUrl,  String? citation,  double? similarity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SimilarImageModel() when $default != null:
return $default(_that.id,_that.url,_that.urlSmall,_that.licenseName,_that.licenseUrl,_that.citation,_that.similarity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String url, @JsonKey(name: "url_small")  String urlSmall, @JsonKey(name: "license_name")  String? licenseName, @JsonKey(name: "license_url")  String? licenseUrl,  String? citation,  double? similarity)  $default,) {final _that = this;
switch (_that) {
case _SimilarImageModel():
return $default(_that.id,_that.url,_that.urlSmall,_that.licenseName,_that.licenseUrl,_that.citation,_that.similarity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String url, @JsonKey(name: "url_small")  String urlSmall, @JsonKey(name: "license_name")  String? licenseName, @JsonKey(name: "license_url")  String? licenseUrl,  String? citation,  double? similarity)?  $default,) {final _that = this;
switch (_that) {
case _SimilarImageModel() when $default != null:
return $default(_that.id,_that.url,_that.urlSmall,_that.licenseName,_that.licenseUrl,_that.citation,_that.similarity);case _:
  return null;
...
class _SimilarImageModel implements SimilarImageModel {
  const _SimilarImageModel({required this.id, required this.url, @JsonKey(name: "url_small") required this.urlSmall, @JsonKey(name: "license_name") this.licenseName, @JsonKey(name: "license_url") this.licenseUrl, this.citation, this.similarity});
  factory _SimilarImageModel.fromJson(Map<String, dynamic> json) => _$SimilarImageModelFromJson(json);

@override final  String id;
@override final  String url;
@override@JsonKey(name: "url_small") final  String urlSmall;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SimilarImageModel&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.urlSmall, urlSmall) || other.urlSmall == urlSmall)&&(identical(other.licenseName, licenseName) || other.licenseName == licenseName)&&(identical(other.licenseUrl, licenseUrl) || other.licenseUrl == licenseUrl)&&(identical(other.citation, citation) || other.citation == citation)&&(identical(other.similarity, similarity) || other.similarity == similarity));
}
...
/// Create a copy of SimilarImageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? url = null,Object? urlSmall = null,Object? licenseName = freezed,Object? licenseUrl = freezed,Object? citation = freezed,Object? similarity = freezed,}) {
